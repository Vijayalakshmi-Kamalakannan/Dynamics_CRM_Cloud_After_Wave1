...
//Test Case 8927:Cloud: Verify AG and AG effective date on Account termination when AG populated based on FBO and Business classification is Acute


public class TestCase_8927 {
	...
	public void createMember(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//2.//2. From the left navigation column ,Go to My Work>Accounts > + New
		    .selectAccountsTab()
		...
		//3. Account  Type = Member
			...
			//Direct Parent Entity Code = MN2003
