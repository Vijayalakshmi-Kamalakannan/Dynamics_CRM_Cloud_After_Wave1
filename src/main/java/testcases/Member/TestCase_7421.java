...
//TFS ID_ 7421:Create New Membership Provider with type "DSH"

public class TestCase_7421 {
	...
	public void createMembershipProvider(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//7. Choose DSH and save the record
		...
		//10 Choose Membership type as "DSH" and search for the CRM# we captured in Step#7
