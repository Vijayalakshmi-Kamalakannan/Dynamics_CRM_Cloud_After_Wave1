...
//TFS ID_ 7474:Change Account status to Terminated for a Membership Provider with type "Aggregation Affiliation"

public class TestCase_7474 {

	  	
	@Test
	public void changeAccountStatusTerminatedMP(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
