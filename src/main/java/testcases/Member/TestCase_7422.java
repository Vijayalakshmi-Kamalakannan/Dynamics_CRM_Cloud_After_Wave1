...
//Test Case 7422:Create New Membership Provider with type "Aggregation Affiliation"

public class TestCase_7422 {
	...
	public void createMembershipProvider(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//10 Choose Membership type as "Aggregation Affiliation" and search for the CRM# we captured in Step#7
