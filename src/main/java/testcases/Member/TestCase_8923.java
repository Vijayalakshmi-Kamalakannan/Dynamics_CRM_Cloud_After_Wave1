...
//Test Case 8923:Cloud: Verify AG and AG effective date on Account termination when AG populated for NONGPO account

public class TestCase_8923 {
	...
	public void createMember(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//7.Observe the AG and AG effective date populated 
			...
			.verifyAgEffectiveDateAsCurrentDate()		
