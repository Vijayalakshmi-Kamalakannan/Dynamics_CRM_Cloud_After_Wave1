...
//Test Case 4525:Verify if a shipto account can be converted to main account



public class TestCase_4525 {


	@Test
	public void VerifyLocationToMain(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
