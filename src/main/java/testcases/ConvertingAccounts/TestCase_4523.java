...
//Test Case 4523:Verify if a main account with draft status can be converted to a shipto account


public class TestCase_4523 {


	@Test
	public void VerifyDrafttoLocationType(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
