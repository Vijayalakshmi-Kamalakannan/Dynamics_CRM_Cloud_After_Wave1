...
//Test Case 4526:Verify if a main account can be converted to mailto account



public class TestCase_4526 {


	@Test
	public void VerifyAccounttoLocationType(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
