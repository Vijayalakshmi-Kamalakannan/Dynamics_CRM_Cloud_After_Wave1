...
public class TestCase_4530 {


	@Test
	public void VerifyLOBAg(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		.verifyLOBRequiredErrorMessage("LOB is required for the below Premier Membership")
