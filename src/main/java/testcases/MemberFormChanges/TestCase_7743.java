...
//Test Case 7743:Verify "Membership" section is available on the top of the Member form.

public class TestCase_7743 {


	@Test
	public void Membershipsection(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
