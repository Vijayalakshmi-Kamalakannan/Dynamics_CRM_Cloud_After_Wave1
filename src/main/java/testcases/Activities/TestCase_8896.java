...
public class TestCase_8896 {
	...
	public void LetterActivity(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		.EnterLetterDetails(DataInputProvider.getCellData_ColName(iRowNumber, "Subject", sDataSheetName), DataInputProvider.getCellData_ColName(iRowNumber, "Due Date", sDataSheetName), DataInputProvider.getCellData_ColName(iRowNumber, "Duration", sDataSheetName), DataInputProvider.getCellData_ColName(iRowNumber, "TaskDetails", sDataSheetName))
		.clickGoBackTaskPage()
